...
def vary_clipping_norm():
    ...
    seeds=[2,20,99]
    clipping_norms = [0.5, 0.25]
    start=144
    counter =0
    for dataset,graph, poisoningType, ratio, structureType,clipping_norm, seed in itertools.product(datasets, graphTypes, poisoningTypes, ratios, structureTypes,clipping_norms, seeds):
