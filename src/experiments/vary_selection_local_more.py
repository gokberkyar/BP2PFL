...
def vary_selection_local_more():
    ...
    poisoningTypes = [True]
    ratios = [ 0.05]
    structureTypes = ['localrandom', 'localens']
    iids = [False, True]
    seeds=[2,20,99]

    start=171
    counter =0
    for dataset,iid, graph, poisoningType, ratio, structureType,seed in itertools.product(datasets,iids, graphTypes, poisoningTypes, ratios, structureTypes,seeds):
